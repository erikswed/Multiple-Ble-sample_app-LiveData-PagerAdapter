...
import com.ble.multiple.adapter.ToyPagerAdapter;
import com.ble.multiple.entity.BatteryEntity;

public class ParentToyFragment extends BaseFragment {

    private ToyPagerAdapter adapter;
    private ViewPager viewpage;

    public static ParentToyFragment newInstance(Bundle args) {
        ParentToyFragment frag = new ParentToyFragment();
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        ToyPagerAdapter adapter = new ToyPagerAdapter(getChildFragmentManager(), bundled);
